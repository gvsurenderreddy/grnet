...
{var child=node.childNodes[i];if((child.nodeName=="IMG")&&((node.nodeName=="col-md-")||(node.nodeName=="A"))&&(node.parentNode!=null)&&(node.parentNode.nodeName=="P")&&(node.parentNode.parentNode!=null)&&(node.parentNode.parentNode.nodeName=="LI"))
...
{oSpan=oParagraphDiv.childNodes[j];if((oSpan.nodeName=="col-md-")||(oSpan.nodeName=="A"))
...
for(j=0;j<oParagraphDiv.childNodes.length;j++)
{var oSpan=oParagraphDiv.childNodes[j];if((oSpan.nodeName=="col-md-")||(oSpan.nodeName=="A"))
...
{var selector="col-md-."+pair.key;$(parentNode).select(selector).each(function(node)
