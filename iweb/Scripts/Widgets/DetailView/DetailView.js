...
{var previousSpans=this.getElementById("previous").select("col-md-");var nextSpans=this.getElementById("next").select("col-md-");var atFirstImage=index==0;var atLastImage=index>=this.mCurrentMediaStream.length-1;var navigationClickHandler=function(i,slideshow)
