...
<div class="container-fluid">
  <header class="page-header"> <!-- InstanceBeginEditable name="page-header" -->
        <h1> 404 Not Found </h1>
        <p class="lead">Who&rsquo;s side are you on?</p>
        <!-- InstanceEndEditable --> </header>
  <div class="row">
    <div class="col-md-12"> <!-- InstanceBeginEditable name="Body" -->
            <p><?php echo 'http://www.monkey-factory.com' . $_SERVER['REQUEST_URI'] ?></p>
...
<!-- InstanceBeginEditable name="bottom-js" --><!-- InstanceEndEditable -->
</body>
<!-- InstanceEnd --></html>
